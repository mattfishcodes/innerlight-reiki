    ...
    <div className='py-3'>
      ...
      <ul className='border-primary/40 bg-primary/20 flex flex-col rounded-md border'>
        <a
          ...
          className='border-primary/40 hover:bg-primary-dark/20 flex items-center gap-1 border-b px-4 py-2'
        >
        ...
        <a
          ...
          className='hover:bg-primary-dark/20 flex items-center gap-1 px-4 py-2'
        >
